...
def move():
    ...
    for key, duration in directions:
        ...
        while t.time() - start_time < duration:
            ...
            t.sleep(0.5)  # Check every 0.5 seconds
        kb.release(key)
...
def cycle():
    ...
    for _ in range(5):
        if not move():
            ...
            return  # Exit cycle if conditions are not met
...
if __name__ == '__main__':
    # Start the thread to update lobby data
